  ...
  return (
    ...
    >
      <div className="w-full md:w-3/5 relative">
        ...
        {/* Landscape Aspect Ratio for all versions */}
        <div className="relative aspect-[16/10] overflow-hidden rounded-[30px] md:rounded-[40px] border border-white/10 bg-white/5 shadow-2xl">
          <motion.img 
            ...
            /* Grayscale removed for better mobile experience */
          />
...
export default function ShahelaUniverse() {
  ...
  const handleUnlock = (e: React.FormEvent) => {
    e.preventDefault();
    const validPassphrases = ["shahela", "meghboti"];
    if (validPassphrases.includes(password.toLowerCase())) {
      setUnlocked(true);
    } else {
      alert("মহাবিশ্বটি এখনো আড়ালে। আবার চেষ্টা করুন।");
    }
  };

  const mainImages = [
    { id: 1, img: "/images/shahela1.jpg", title: "স্নিগ্ধ হাসির মায়াজাল",
  desc: "এক চিমটি হাসিতেই যেন থমকে দাঁড়ায় মহাবিশ্বের সব ব্যস্ততা।" },
    { id: 2, img: "/images/shahela2.jpg", title: "শীতল চাহনি",
  desc: "কালো চশমার আড়ালে লুকানো রহস্যময়ী এক হাসি।" },
    { id: 3, img: "/images/shahela3.jpg", title: "শাশ্বত স্নিগ্ধতা",
  desc: "শান্ত চোখের মায়ায় বোনা এক টুকরো নিভৃত কাব্য।"
 },
    { id: 4, img: "/images/shahela4.jpg", title: "নিভৃত আনমনা",
  desc: "সবুজের ইশারায় দূর অজানা কোনো স্বপ্নের খোঁজে।" },
    { id: 5, img: "/images/shahela5.jpg", title: "রেশমি রিনঝিন",
  desc: "লাল চুড়ির আবদারে মিশে থাকা এক চিলতে দুষ্টুমি আর আভিজাত্য।" },
  ];
      ...
      <AnimatePresence mode="wait">
        {!unlocked ? (
          <motion.div 
            ...
            className="relative z-50 flex items-center justify-center min-h-screen px-6"
          >
            <div className="bg-white/[0.03] border border-white/10 backdrop-blur-[50px] p-12 md:p-20 rounded-[60px] shadow-2xl max-w-lg w-full text-center">
              <motion.div animate={{ scale: [1, 1.1, 1] }} transition={{ repeat: Infinity, duration: 3 }} className="w-16 h-16 bg-rose-600 rounded-full mx-auto mb-12 shadow-[0_0_50px_rgba(225,29,72,0.6)]" />
              <h2 className="text-xs tracking-[1em] uppercase text-rose-500 font-black mb-10 font-['Hind_Siliguri']">ভেরিফিকেশন প্রয়োজন</h2>
              <form onSubmit={handleUnlock}>
                <input 
                  ...
                  className="bg-transparent border-b-2 border-white/10 py-4 text-2xl text-center outline-none focus:border-rose-600 w-full mb-12 transition-all tracking-widest font-light placeholder:text-white/10 font-['Hind_Siliguri']" 
                />
                <button type="submit" className="w-full py-5 bg-rose-600 hover:bg-white hover:text-black rounded-full text-[11px] font-black tracking-[0.4em] uppercase transition-all duration-500 shadow-xl font-['Hind_Siliguri']">
                  গোপন আর্কাইভ খুলুন
                </button>
              </form>
            </div>
...
<section className="bg-white/[0.02] border border-white/10 backdrop-blur-3xl rounded-[60px] md:rounded-[100px] p-8 md:p-24 shadow-2xl relative overflow-hidden">
  ...
  <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4 md:gap-8">
    {[...Array(12)].map((_, i) => {
      // ৫ম ইমেজের জন্য (index 4) .png এবং বাকিগুলোর জন্য .jpg
      ...
      return (
        ...
        >
          ...
          <div className="absolute inset-0 bg-rose-600/10 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none"></div>
              ...
              {/* Lightbox Modal remains colored too */}
              <AnimatePresence>
                {selectedImage && (
                  <motion.div 
                    initial={{ opacity: 0 }}
                  ...
                  >
                    <motion.div 
                      ...
                      className="relative max-w-5xl w-full aspect-square md:aspect-video rounded-[30px] md:rounded-[40px] overflow-hidden border border-white/10 shadow-2xl"
                    >
